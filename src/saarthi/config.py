...
class Settings(BaseSettings):
    ...
    # Coda is the current Rime conversational model. Nadi is listed for
    # Hindi; Coda's English catalog uses a separate English speaker.
    rime_model: str = "coda"
    rime_english_speaker: str = "astra"
